...
namespace Connectamente.API.Controllers
{
    ...
    [ApiController]
    public class RegistroPensamentoController : ControllerBase
    {
        private readonly AppDbContext _context;

        public RegistroPensamentoController(AppDbContext context)
        {
            _context = context;
        }

        // GET: api/RegistroPensamento
        [HttpGet]
        ...
        // DELETE: api/RegistroPensamento/5
        [HttpDelete("{id}")]
